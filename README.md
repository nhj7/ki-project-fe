...
Vue.js 를 초기화하고 라우팅 설정, Vuetify 테마 구성을 포함합니다. 주요 특징은 다음과 같습니다:  
...
- `vue/App.vue`: 메인 컴포넌트로, 전체 레이아웃과 네비게이션을 관리합니다. 알림 목록 관리, 다크/라이트 테마 전환, 글로벌 변수 등 애플리케이션 전반의 기능을 제어합니다.

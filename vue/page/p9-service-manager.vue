            ...
            <v-treeview :items="treeItems" activatable="true" item-key="id" return-object
              ...
              <template v-slot:label="{ item }">
                <div class="d-flex justify-space-between align-center">
                  <div>
                    <strong>{{ item.serviceName || item.txName }}</strong> ({{ item.serviceName ? item.serviceID :
                    item.txID }})
                  </div>
                  <!--div>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-form ref="form" v-model="isFormValid">
            <v-text-field v-model="form.serviceID" label="서비스 ID" :rules="[v => !!v || '서비스 ID는 필수입니다.']"
              required></v-text-field>
            <v-text-field v-model="form.serviceName" label="서비스명" :rules="[v => !!v || '서비스명은 필수입니다.']"
              required></v-text-field>
            <v-text-field v-model="form.description" label="설명" :rules="[v => !!v || '설명은 필수입니다.']"
              required></v-text-field>
          </v-form>
        </v-card-text>
        <v-card-actions>

            ...
            try {
                ...
                this.rules = [
                    ...
                    },
                    {
                        name: '피크 시간 거래 부재',
                        type: '거래 부재',
                        condition: '피크 시간(9:00-11:00, 13:00-15:00) 동안 5분 이상 거래 없음',
                        action: '즉시 시스템 상태 점검 및 고객 서비스 채널 모니터링 강화'
                    },
                    {
                        name: '특정 거래 유형 오류 증가',
                        type: '오류율 증가',
                    ...
                    },
                    {
                        name: '월간 오류율 트렌드',
                        type: '오류율 증가',
                        condition: '3개월 연속 월간 오류율 5% 이상 증가',
                        action: '종합적인 시스템 안정성 검토 및 개선 계획 수립'
                    },
                    {
                        name: '대량 거래 처리 지연',
                        type: '거래 부재',
                    ...
                    },
                    {
                        name: '거래 처리 응답 지연',
                        type: '응답지연',
                        condition: '평균 거래 처리 시간 5초 이상 지속 (정상: 2초 이내)',
                        action: '시스템 리소스 점검 및 데이터베이스 쿼리 최적화 검토'
                    },
                    {
                        name: '결제 게이트웨이 응답 지연',
                        type: '응답지연',
                        condition: '결제 게이트웨이 응답 시간 10초 이상 (정상: 3초 이내)',
                        action: '결제 서비스 제공업체에 연락 및 대체 결제 수단 활성화'
                    },
                    {
                        name: '갑작스러운 거래량 증가',
                        type: '거래증가',
                    ...
                    },
                    {
                        name: '특정 상품 거래 급증',
                        type: '거래증가',
                        condition: '특정 상품의 시간당 거래량이 평균의 500% 이상 증가',
                        action: '해당 상품 재고 확인 및 가격 오류 여부 검토'
                    },
                    {
                        name: '동일 사용자 반복 로그인 시도',
                        type: '반복수행',
                        condition: '단일 사용자가 1분 내 10회 이상 로그인 시도',
                        action: '해당 계정 일시 잠금 및 보안팀에 알림'
                    },
                    {
                        name: '반복적인 데이터 조회 요청',
                        type: '반복수행',
                        condition: '동일 IP에서 특정 API에 대해 초당 100회 이상 호출',
                        action: '해당 IP 일시 차단 및 API 사용량 제한 적용'
                    }
                ];
            } catch (error) {
